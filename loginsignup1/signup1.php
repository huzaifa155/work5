...
if(isset($_POST['submit'])) {
    ...
    $signup = "INSERT INTO `registration`(`user_name`, `user_email`, `user_password`) VALUES ('$user_name','$user_email','$user_passowrd')";

    $result = $sonn->query($signup);
    if ($result == true) {
        ?>
        <script>
        ...
        <div class="card bg-glass">
          <div class="card-body px-4 py-5 px-md-5">
            <form action="signup.php" method="POST">
              ...
              <!-- Submit button -->
              <button type="submit" name="submit" class="btn btn-primary btn-block mb-4" value="submit">
                Sign up
              </button>
